...
//  Planit
//
//  Created by Vasudha Srinivasan on 2/6/21.
//  Copyright © 2021 Vasudha Srinivasan. All rights reserved.
//Basic List Template from: https://bruno.ph/blog/articles/swift-tutorial-mytodo/
//

import UIKit

//create class to control main list page
class ViewController: UITableViewController {

    //set up for list page
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        
        self.view.backgroundColor = UIColor(red: 213/255.0, green: 221/255.0, blue: 240/255.0, alpha: 1)
